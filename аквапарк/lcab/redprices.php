<div id="pricetablered" class="pricetablemen">
							...
							<div class="pricetablemenbtn">
								<form method="post">
									...
									<input type="text" name="redysluga" class="forminputtable" placeholder="Название усл.">
									<input type="text" name="redage" class="forminputtable" placeholder="Возраст">
								...
								if(isset($_POST['redredtable'])){
									...
									$zaprosnared = "UPDATE `tovar` SET `ysluga` = '$redysluga', `old` = '$redage', `time` = '$redtime', `price` = '$redtime' WHERE `tovar`.`id` = '$redid'";
